require = function() {
    ...
    34: [function(t, e, o) {
        ...
        var r = t("@marcom/ac-headjs"),
            ...
            i = t("@marcom/feature-detect/isDesktop"),
            a = document.documentElement.classList.contains("aow"),
            c = t("@marcom/feature-detect/prefersReducedMotion"),
            s = t("@marcom/feature-detect/canvasAvailable"),
            u = t("@marcom/feature-detect/webGLAvailable");
        r.addTests({
            "reduced-motion": c(),
            webgl: u,
            ie: n.browser.ie,
            edge: n.browser.edge,
            "win-firefox": n.os.windows && n.browser.firefox,
            "hero-inline-video": !c() && !a && (i() || n.os.ios && n.os.version.major >= 10),
            "inline-video": !c() && !a && (i() || n.os.ios && n.os.version.major >= 10),
            "sprite-sheet-player": s() && !a,
            "siri-wave": u && !c() && !a,
            "hero-animation": u && !c() && !a && (i() || n.os.ios && n.os.version.major >= 10) && !n.browser.ie && !n.browser.firefox,
            "sprite-animations": s() && !a && !n.browser.firefox && !c()
        }), r.htmlClass()
    }, {
        "@marcom/ac-headjs": 7,
